        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Component Categories</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="form-group input-daterange">
                ...
                <input type="date" class="form-control" name="date" id="date" style="width:200px;">
                  ...
                  <div class="col-sm-2">
                    <a href="{{ route('component-categories.create') }}" class="btn btn-block btn-outline-primary">Add New</a>
                  </div>
                </div>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="component-category-table" class="table table-bordered table-hover" style="width: 100%;">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Component Category Title</th>
                      {{-- <th>Component Category Desciption</th> --}}
                      <th>Image</th>
...
@parent
  ...
  <script>
    $(function() {
      ...
      var dataTable = $('#component-category-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          headers: {
          ...
          url: '{!! route('get.component.category') !!}',
          data: function (d) {
    ...
    function clearFilter() {
      ...
      $('#filterdata').val('');
      $('#component-category-table').DataTable().draw();
      $('.clearFilter').hide();
    }
