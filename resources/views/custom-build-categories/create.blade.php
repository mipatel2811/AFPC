  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Custom Build Categories</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
              <li class="breadcrumb-item active">Add Custom Build Category</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {{ Form::open(['route' => 'custom-build-categories.store', 'role' => 'form', 'method' => 'post', 'id' => 'create-custom-build-categoy', 'files' => true]) }}
...
@section('scripts')
  <script>
    $(function() {
      ...
      $('#create-custom-build-categoy').validate({
        rules: {
          title: {
            required: true,
          },
