  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Custom Build</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
              <li class="breadcrumb-item active">Update Custom Build</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!! Form::model($customBuildCategories , ['route' => ['custom-build.update', $customBuild->id], 'role' => 'form', 'method' => 'PATCH', 'files' => true, 'id' => 'update-custom-build']) !!}

              @include("custom-build.edit-form")
...
<script>
    $(function() {
      ...
      $(".component-sorting").sortable({
        stop: function (e, ui) {
            var id = ui.item[0].classList[1].split("_")[1];
            var data = $(this).sortable('serialize');
            var obj={};
            $.each(data.split("&"), function (indexInArray, valueOfElement) {
    ...
    //   s2.val([' ']).trigger("change");
      ...
      var summernoteForm = $('#update-custom-build');
