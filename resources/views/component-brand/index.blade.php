        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Component Brand</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <input type="date" class="form-control" name="date" id="date" style="width:200px;">
                  ...
                  <div class="col-sm-2">
                    <a href="{{ route('component-brand.create') }}" class="btn btn-block btn-outline-primary">Add New</a>
                  </div>
                </div>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="component-brand" class="table table-bordered table-hover" style="width: 100%;">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Brand Title</th>
...
@parent
  ...
  <script>
    $(function() {
      ...
      var dataTable = $('#component-brand').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          headers: {
    ...
    function clearFilter() {
      ...
      $('#reservation').val('');
      $('#component-brand').DataTable().draw();
      $('.clearFilter').hide();
    }
        ...
        if (result.isConfirmed) {
          $.ajax({
            ...
            success: function(response) {
              Swal.fire({
                title: 'Deleted!',
                text: "Your Component Brand has been deleted.",
                icon: 'success',
              }).then((result) => {
