        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {{ Form::open(['route' => 'components.store', 'role' => 'form', 'method' => 'post', 'id' => 'create-component', 'files' => true]) }}
  ...
  <script>
    $(function() {
      ...
      var s2 = $(".js-brand-tags").select2({
        allowClear: true,
        placeholder: "Select Component Brand",
        tags: true,
      });
      s2.val([' ']).trigger("change");
      $('#create-component').validate({
        rules: {
          title: {
            required: true,
          },
        ...
        messages: {
          ...
          image: {
            required: "Please select Component image",
          },
          is_active: {
            required: "Please select component Status",
          },
        },
        errorElement: 'span',
      ...
      var summernoteForm = $('#create-component');
