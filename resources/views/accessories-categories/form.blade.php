<div class="card-body">
  ...
  <div class="form-group">
    ...
    @endif
    @if (isset($accessoryCategory->image) && $accessoryCategory->image != '')
      <br />
      <img src="{{ asset('/public/img/accessories-categories/' . $accessoryCategory->image . '') }}" height='100'>
    @endif
  </div>
  <div class="form-group">
    {{ Form::label('componets', 'Choose accessories', ['class' => 'control-label required']) }}
    <select multiple="multiple" name="accessories[]" class="duallistbox">
      @if (isset($accessoryCategory))
        @if (isset($selectedAccessory) && count($selectedAccessory))
          @foreach ($selectedAccessory as $key => $value)
  ...
  <div class="form-group">
    ...
    <div class="form-group clearfix">
      <div class="icheck-primary d-inline mr-3">
        <input type="radio" id="radioPrimary1" name="is_active" @if (isset($accessoryCategory->is_active) && $accessoryCategory->is_active == 1) checked @endif value="1">
        <label for="radioPrimary1">Yes</label>
      </div>

      <div class="icheck-primary d-inline">
        <input type="radio" id="radioPrimary2" name="is_active" @if (isset($accessoryCategory->is_active) && $accessoryCategory->is_active == 0) checked @endif value="0">
